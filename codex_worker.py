...
SUPPORT_FILES = ("strategy_types.py", "backtest.py", "thesis.md")
...
def build_codex_prompt(context: WorkerContext) -> str:
    ...
    return textwrap.dedent(
        ...
        - Do not edit backtest.py, evaluator.py, strategy_registry.py, or strategy_types.py.
...
def main() -> None:
    ...
    parser.add_argument("--parent", type=Path, default=Path("strategy.py"))
