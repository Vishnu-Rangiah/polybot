...
from kalshi_agent.autoresearch.registry import DEFAULT_REGISTRY_PATH, load_strategy_candidate
from kalshi_agent.autoresearch.worker import CodexModalWorker, WorkerContext
...
def score_strategy_source(source: str, split: str) -> dict:
    ...
    from kalshi_agent.autoresearch.backtest import backtest, load_cases
